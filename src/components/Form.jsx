          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden bg-[#9aabb2] py-10 px-6 sm:px-10 xl:p-12">
              ...
              <p className="mt-6 max-w-3xl text-base text-gray-900 text-justify">
                Nos services sont disponibles pour vous répondre du lundi au
                vendredi, de 8h30 à 12h et de 13h30 à 17h. Si vous souhaitez
                effectuer une candidature spontanée suite à une annonce sur l’un
                de nos sites partenaires, nous vous remercions de stipuler le
                numéro d’offre dans l’objet de votre formulaire de contact.
              </p>
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-gray-900">
                  ...
                  <span className="ml-3">
                    <a
                      href="maito:contact@association-prestatair.com"
              ...
              <div>
                <div className="map-container-2 w-full">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d11612.31904646705!2d3.4713674!3d43.3125897!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x478ba1b5dd76e905%3A0xec564c6f35ee459c!2sPRESTAT&#39;AIR!5e0!3m2!1sfr!2sfr!4v1676047078034!5m2!1sfr!2sfr"
                    width="600"
                    height="450"
                    loading="lazy"
            ...
            <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
              ...
              <form
                action="https://formsubmit.co/contact@association-prestatair.com"
                method="POST"
                ...
                {isCookiesAccepted ? (
                  ...
                  <div>
                    <button onClick={acceptCookies}>
                      Merci d'accepter au préalable les cookies en cliquant ici
                    </button>
                  </div>
                )}
              </form>
