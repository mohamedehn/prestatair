...
export default function Display() {
  return (
    <Carousel className="md:w-[70%] h-auto w-full object-cover justify-center flex m-auto">
      <Carousel.Item>
        <img className="d-block w-100 h-auto" src={dog} alt="First slide" />
        <Carousel.Caption>
          <p>Soin et promenade d'animaux de compagnie</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        <img className="d-block w-100" src={garden} alt="Second slide" />
      ...
      <Carousel.Item>
        <img className="d-block w-100" src={plumber} alt="Third slide" />
