...
export default function Hero() {
  return (
    <div
      className="relative overflow-hidden bg-[#adccd0] h-screen"
      id="accueil"
    >
          ...
          <main className="mx-auto mt-10 max-w-7xl px-6 sm:mt-12 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                ...
                <span className="block text-[#225a65] xl:inline">
                  <br />
                  Un nouveau souffle dans votre quotidien.
                </span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0 text-justify">
                L’association Prestat’air, spécialisée dans les services à la
                personne, est disponible pour répondre aux besoins de ses
                clients, ainsi qu’à ceux de ses aides à domicile.
              </p>
