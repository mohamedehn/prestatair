    ...
    <div className="w-full sm:pt-[50px]" id="activities">
      <div className="max-w-[1240px] mx-auto px-2 py-16">
        ...
        <div className="block md:flex justify-between flex-wrap md:gap-10 gap-32">
          ...
          <Activities
            activities="Petits travaux de jardinage"
            img={jardinage}
          />
          <Activities
            activities="Petits travaux de bricolage"
            img={renovation}
          />
          <Activities
            activities="Garde d’enfants de plus de trois ans, à domicile "
            img={garde}
          />
          <Activities
            activities="Accompagnement des enfants de plus de trois ans "
            img={enfants}
          />
          <Activities activities="Soutien scolaire" img={devoirs} />
          <Activities activities="Livraison de courses" img={courses} />
          <Activities
            activities="Préparation de repas à domicile "
            img={chef}
          />
          ...
          <Activities
            activities="Soin et promenade d’animaux de compagnie "
            img={chien}
          />
        </div>
      </div>
