      ...
      <div className="relative md:bg-[#adccd0] md:p-6 mx-auto max-w-7xl px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-1 lg:gap-6">
          ...
          >
            <div>
              <p
                className="text-gray-900 font-semibold flex mx-auto w-auto justify-center"
                id="mentions"
              >
                MENTIONS LEGALES
              </p>
              ...
              <p>
                Le présent site est la propriété de L’association Prestat’air{" "}
                <br />
                Siège social : 42 Rue du Rouet 34300 Agde - Tél : 04 30 41 84 90{" "}
                <br />
                Email: contact@association-prestatair.com <br />
                Entreprise/ Association créée en 2019 – code 8810A - Convention
                3127 - SIRET : 852 904 143 00025 <br />
            ...
            <div>
              ...
              <p>
                ...
                https://www.association-prestatair.com/ peuvent être amenés à
                fournir des informations nominatives ou à caractère personnel
                dans le cadre des services proposés par l’association
                Prestat’air.
              </p>
              <p>
                L’association Prestat’air est responsable de traitement au sens
                ...
                site accessible à l’adresse <br /> URL:
                https://www.association-prestatair.com/
              </p>
              <p>
                L’association Prestat’air traite les données personnelles
                collectées via son site pour les finalités suivantes :
              </p>
              <p>
                - Afin de permettre au visiteur du site d’obtenir des
                informations sur les services proposés par l’association
                Prestat’air et les conditions d’éligibilité.
                <br />
                ...
                - Un courriel au Responsable de Traitement de L’association
                Prestat’air <br />
              ...
              <p>
                Si le visiteur estime que l’association Prestat’air n’a pas
                correctement répondu à ses sollicitations, il dispose d’un droit
                d’introduire une réclamation auprès de la CNIL. L’association
                Prestat’air limite la collecte des données personnelles au
                strict nécessaire au regard des finalités des traitements de
                données, elles sont destinées à l’association Prestat’air mais
                sont susceptibles d’être transférées à des organismes publics
                afin de mieux répondre à la demande du visiteur.
              </p>
              <p>
              ...
              <p>
                L’association Prestat’air veille à ce que toutes les mesures
                techniques et organisationnelles afin de protéger les données
                personnelles soient mises en œuvre, ces règles de
                confidentialités et de sécurité sont également imposées à
                l’ensemble du personnel de l’association Prestat’air , ainsi
                qu’à tous les prestataires et sous-traitants travaillant pour
                l’association Prestat’air.
              </p>
            </div>
